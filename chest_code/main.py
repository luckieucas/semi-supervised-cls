...
parser.add_argument('--labeled_bs', type=int, default=8, help='num of labeled samples in each batch')
...
parser.add_argument('--train_bs', type=int, default=16, help='train batchsize')
...
parser.add_argument('--bnm_filter_prob', type=bool, default=False, help='whether bnm filter')
...
parser.add_argument('--mixup', type=bool, default=False, help='whether do mixup')
parser.add_argument('--is_sharpen', type=bool, default=False, help='whether do mixup')
#Miscs
