...
parser.add_argument('--bnm_filter_prob', type=bool, default=False, help='whether bnm filter use prob')
parser.add_argument('--bnm_filter_batch', type=bool, default=False, help='whther bnm filter batch')
