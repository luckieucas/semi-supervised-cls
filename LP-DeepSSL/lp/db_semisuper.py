...
def make_dataset_new(pathDatasetFile, pathImageDirectory):
    images = []
...
class DatasetFolder(data.Dataset):
    ...
    def __init__(self, root, loader, extensions, transform=None, target_transform=None):
        ...
        classes = [ 'Melanoma', 'Melanocytic nevus', 'Basal cell carcinoma', 'Actinic keratosis',
                            'Benign keratosis', 'Dermatofibroma', 'Vascular lesion']
        #samples = make_dataset(root, class_to_idx, extensions)
        samples = make_dataset_new('/media/luckie/vol4/semi_supervised_cls/dataset/skin/training.txt',
                                '/media/luckie/vol4/semi_supervised_cls/dataset/skin/training_data/')
        if len(samples) == 0:
