...
def main():
    ...
    wandb.init(project='skin_label_prob', name="stage_2")
    ...
    AUROC_avg, Accus_avg, F1_avg = epochTest(args, wandb, model, args.start_epoch, eval_loader)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.evaluation_epochs and (epoch + 1) % args.evaluation_epochs == 0:
            ...
            AUROC_avg, Accus_avg, F1_avg = epochTest(args, wandb, model, epoch, eval_loader)
            if args.isMT:
                ...
                is_best = AUROC_avg > best_auc
                best_auc = max(AUROC_avg, best_auc)                
        else:
            is_best = False
...
if __name__ == '__main__':
    ...
    args.class_names = CLASS_NAMES_DICTS['skin']
    args.class_num = CLASS_NUM_DICTS['skin']
